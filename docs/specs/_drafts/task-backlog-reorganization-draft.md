...
> [!NOTE]
> このファイルは `docs/specs/task-backlog.md` 再編用の比較ドラフトです。
> 正本は `docs/specs/task-backlog.md` とし、再編内容のレビューが完了するまで正本を変更しません。
> 再編完了後は、正本への反映と同時にこのドラフトを削除します。
...
- 依存関係: docs 整理
- すぐ実装できるか: `可`
- GitHub Issue: `#9 天気関連仕様書のcurrent・planned・legacy記載を整理する`
- 移行状況: GitHubへ移行済み
...
- 依存関係: current UI 確認
- すぐ実装できるか: `可`
- GitHub Issue: `#10 着用履歴の日詳細モーダルの情報配置を見直す`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要確認`
- GitHub Issue: `#3 着用履歴で選択済みアイテムのカテゴリ・形が未設定表示になる`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `可`
- GitHub Issue: `#12 買い物メモ追加モードで選択中の候補を分かりやすくする`
- 移行状況: GitHubへ移行済み
...
- 依存関係: closed 方針整理
- すぐ実装できるか: `要設計`
- GitHub Issue: `#14 終了済み買い物メモの表示と操作制御を整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#15 サムネイルの極小表示とallinone構成の描画方針を整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `可`
- GitHub Issue: `#16 dropdown・popoverの表示領域と重なり順ルールを整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#17 購入検討の削除不可理由から買い物メモへ移動する導線を整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `可`
- GitHub Issue: `#18 詳細画面ヘッダーを共通レイアウトテンプレートへ揃える`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#19 セッション切れ時の通知とログイン後復帰導線を整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#20 予報から実績へ更新する際の差分確認UIを整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#21 着用履歴と天気登録の相互リンクを整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#22 着用履歴一覧から振り返りへ移動する導線を整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#23 コーディネート作成・編集の季節・TPO配置と選択中アイテム表示を整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要確認`
- GitHub Issue: `#24 アイテム・購入検討候補カードのブランド表示ルールを整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#25 全体UIの基準と共通化対象を整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#26 着用履歴の保存・状態変更直後に表示する振り返り案内を整理する`
- 移行状況: GitHubへ移行済み
...
- 依存関係: タグ運用の実績確認
- すぐ実装できるか: `要設計`
- GitHub Issue: `#11 セットアップアイテムの登録と関連付けに対応する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#27 アイテム状態管理の後続拡張と再検討条件を整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `一部対応済み`
- GitHub Issue: `#28 素材・混率のDB制約と後続拡張の境界を整理する`
- 移行状況: GitHubへ移行済み
...
- 依存関係: 素材・状態・TPO 設計
- すぐ実装できるか: `要設計`
- GitHub Issue: `#29 アイテム一覧の追加フィルタと状態別表示方針を整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#30 アイテム単位の着用統計と初期表示範囲を整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `可`
- GitHub Issue: `#7 購入検討から買い物メモへ追加する導線を拡張する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `可`
- GitHub Issue: `#6 着用履歴登録時にアイテムからコーディネート候補を探せるようにする`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#1 コーディネート参考メモ・画像管理と購入検討リンク`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#31 既存アイテムの色違いグループ化・解除・移動ルールを整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#5 ログ・エラー設計の運用ルールを整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#32 購入検討TPOのIDベース化とwear logへの適用境界を整理する`
- 移行状況: GitHubへ移行済み
...
- 依存関係: TPO / brand 方針確定
- すぐ実装できるか: `要設計`
- GitHub Issue: `#33 色・季節・TPO・ブランドの保存正本と共通解決責務を整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `可`
- GitHub Issue: `#34 実寸自由項目の利用実績を調査しstructured templateへの昇格対象を決める`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#4 購入検討・買い物メモの期限表示設計を整理する`
- 移行状況: GitHubへ移行済み
...
- 依存関係: 実運用フィードバック
- すぐ実装できるか: `要設計`
- GitHub Issue: `#35 カテゴリ別のsubcategory・shape・specの責務と再判断条件を整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#13 インポート時に除外したフィードバックタグの通知方針を整理する`
- 移行状況: GitHubへ移行済み
...
- 依存関係: URL サンプル確認
- すぐ実装できるか: `要設計`
- GitHub Issue: `#36 楽天市場URLを店舗単位でgroup化できるか確認する`
- 移行状況: GitHubへ移行済み
...
- 依存関係: 素材・混率管理方針
- すぐ実装できるか: `要設計`
- GitHub Issue: `#37 item・購入検討で管理するケア情報と引き継ぎ方針を整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#38 item起点のコーディネート検索導線の適用範囲を整理する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#39 item選択UIのカテゴリ・種類絞り込みの残件を確認する`
- 移行状況: GitHubへ移行済み
...
- すぐ実装できるか: `要設計`
- GitHub Issue: `#40 item・購入検討の候補選択UIの共通化範囲を整理する`
- 移行状況: GitHubへ移行済み
...
- 依存関係: 正本 docs の役割定義
- すぐ実装できるか: `可`
- GitHub Issue: `#8 機能仕様書の役割と入口を整理する`
- 移行状況: GitHubへ移行済み
...
- 伸縮性 / 裏地 / 洗濯方法 / 洗濯表示
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `DES-09 / #37 item・購入検討で管理するケア情報と引き継ぎ方針を整理する`。素材・混率の実装タスクは `FEAT-03`
- セットアップ登録・リンク追加
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `FEAT-01 / #11 セットアップアイテムの登録と関連付けに対応する`
- 今季よく着たアイテムの統計
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `FEAT-05 / #30 アイテム単位の着用統計と初期表示範囲を整理する`
- アイテム削除
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `FEAT-02 / #27 アイテム状態管理の後続拡張と再検討条件を整理する`
- コーディネート参考メモ・画像管理、購入検討とのリンク
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `FEAT-08` / `#1 コーディネート参考メモ・画像管理と購入検討リンク`
- 着用履歴からアイテム単位での着用回数集計
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `FEAT-05 / #30 アイテム単位の着用統計と初期表示範囲を整理する`
- 特定TPOを一覧で初期表示しない
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `DES-10` / `#2 特定TPOの初期表示制御`。`settings/tpos.md` の inactive 表示とは別論点
- ログ設計
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `DES-01 / #5 ログ・エラー設計の運用ルールを整理する`
- 機能単位のdocsフォーマット化 / 重複整理
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `DOC-01 / #8 機能仕様書の役割と入口を整理する`
- 画面遷移図
  - 対応状況: backlog 追加済み
  - 対応 backlog / メモ: `DOC-04`
- 正規化
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `DES-02 / #32 購入検討TPOのIDベース化とwear logへの適用境界を整理する`, `DES-03 / #33 色・季節・TPO・ブランドの保存正本と共通解決責務を整理する`
- 旧天気API関連のPhase E以降
  - 対応状況: docs 明記あり
  - 対応 backlog / メモ: `DEF-04`
- purchase candidate TPOのIDベース化
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `DES-02 / #32 購入検討TPOのIDベース化とwear logへの適用境界を整理する`
- 色名解決helper共通化
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `DES-03 / #33 色・季節・TPO・ブランドの保存正本と共通解決責務を整理する`
- 実寸自由項目のtemplate昇格
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `DES-04 / #34 実寸自由項目の利用実績を調査しstructured templateへの昇格対象を決める`
- `sale_ends_at` / `discount_ends_at` のinternal name見直し
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `DES-05 / #4 購入検討・買い物メモの期限表示設計を整理する`
- 買い物メモの期限表示詳細化
  - 対応状況: docs 明記あり
  - 対応 backlog / メモ: `UI-02`
- custom dropdown / popover とボトムナビの重なり確認
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `UI-06 / #16 dropdown・popoverの表示領域と重なり順ルールを整理する`
- 天気の予報→実績更新時の差分表示
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `UI-11 / #20 予報から実績へ更新する際の差分確認UIを整理する`
...
- 着用履歴と天気登録の相互リンク
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `UI-13 / #21 着用履歴と天気登録の相互リンクを整理する`
- 着用履歴の振り返り導線改善
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `UI-14 / #22 着用履歴一覧から振り返りへ移動する導線を整理する`
- アイテムからコーディネートを検索する
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `FEAT-07 / #6 着用履歴登録時にアイテムからコーディネート候補を探せるようにする`
- コーディネート作成時のアイテム選択 UI 改善
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `UI-15 / #23 コーディネート作成・編集の季節・TPO配置と選択中アイテム表示を整理する`
- 楽天URLの店単位 group 化確認
  - 対応状況: GitHubへ移行済み
  - 対応 backlog / メモ: `DES-08 / #36 楽天市場URLを店舗単位でgroup化できるか確認する`
...
- [ ] 冒頭説明を task backlog の現在の役割に合わせる
- [ ] サマリ件数を本文と一致させる
- [ ] 1タスクの基本フォーマットを確定する
- [ ] IDの欠番は詰めずに維持する
- [ ] `種別` 欄を削除するか判断する
- [ ] `関連機能` と `対象` の統合可否を判断する
- [ ] `優先度` と `着手可否` を維持する

### タスク本文

- [ ] 対応済み仕様の詳細を個別仕様書へ寄せる
- [ ] 判断経緯、試行結果、採用しなかった案を開発ログへ寄せる
- [ ] 残件判断に必要な前提だけを1〜2行残す
- [ ] 複数目的を持つ巨大タスクを分割または親子関係へ整理する
- [ ] 重複タスクを統合する
- [ ] 完了済み内容だけで構成されるタスクを削除する
...
- [ ] `重複統合メモ` の移管・削除方針を決める
- [ ] `手元タスクとの対応` の移管・削除方針を決める
- [ ] `次に進める候補 3 件` を削除する
- [ ] `運用案` を削除する

### 正本化前確認

- [ ] 削除する現在仕様が個別仕様書へ記載済みである
- [ ] 必要な判断経緯が開発ログへ記録されている
- [ ] 未完了タスクと未決定事項が欠落していない
- [ ] 親子タスクの境界が明確である
- [ ] サマリ件数が本文と一致している
- [ ] IDの重複がない
- [ ] 参照先のfile pathが有効である
- [ ] 正本へそのまま反映できる状態になっている
