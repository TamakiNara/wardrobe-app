...
- `subcategory` は全カテゴリで一律必須にはせず、まず `tops`、`pants`、`outerwear`、`onepiece_dress`、`allinone`、`bags`、`fashion_accessories` を中心に UI へ導入し、`skirts`、`shoes`、`kimono` は代表カテゴリまたは `null` 許容で始める
