...
describe("POST /api/items/[id]/dispose", () => {
  ...
  it("Laravel の dispose API へ転送する", async () => {
    global.fetch = vi
      .fn()
    ...
    const req = new Request("http://localhost:3000/api/items/1/dispose", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
    ...
    expect(global.fetch).toHaveBeenNthCalledWith(
      2,
      "http://localhost:8000/api/items/1/dispose",
