...
describe("POST /api/outfits/[id]/restore", () => {
  ...
  it("Laravel の restore API へ転送する", async () => {
    global.fetch = vi
      .fn()
    ...
    const req = new Request("http://localhost:3000/api/outfits/1/restore", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
    ...
    expect(global.fetch).toHaveBeenNthCalledWith(
      2,
      "http://localhost:8000/api/outfits/1/restore",
