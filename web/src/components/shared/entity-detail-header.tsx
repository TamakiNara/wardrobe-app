...
export function EntityDetailBreadcrumbs({
  items,
}: {
        ...
        <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between md:gap-8">
          <div className="min-w-0 max-w-2xl space-y-3">
            ...
            <div className="space-y-3">
              <h1 className="min-h-8 text-2xl font-bold tracking-tight text-gray-900">
                {title}
              </h1>
          ...
          {actions ? (
            <div className="flex w-full flex-wrap items-center gap-3 md:w-auto md:flex-none md:self-center md:justify-end">
              {actions}
            </div>
          ) : null}
        </div>
