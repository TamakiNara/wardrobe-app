...
import { House, Settings, Shirt, Sparkles } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-screen-sm px-3 pb-[calc(env(safe-area-inset-bottom)+0.75rem)]">
        <div className="grid h-16 grid-cols-4 rounded-2xl border border-gray-200 bg-white/95 p-1 shadow-lg shadow-gray-200/70 backdrop-blur">
