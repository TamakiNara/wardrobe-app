...
export function OutfitsPageBreadcrumbs({ items }: { items: BreadcrumbItem[] }) {
  return (
...
export function OutfitsPageHeader({
  breadcrumbs,
  eyebrow,
  title,
  description,
  actions,
}: OutfitsPageHeaderProps) {
  return (
    <>
      <OutfitsPageBreadcrumbs items={breadcrumbs} />
