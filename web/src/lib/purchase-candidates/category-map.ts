const PURCHASE_CANDIDATE_ITEM_CATEGORY_MAP = {
  ...
  pants_denim: { category: "pants", shape: "pants" },
  pants_slacks: { category: "pants", shape: "pants" },
  pants_cargo: { category: "pants", shape: "pants" },
  pants_chino: { category: "pants", shape: "pants" },
  pants_sweat_jersey: { category: "pants", shape: "pants" },
  pants_other: { category: "pants", shape: "pants" },
  ...
  bottoms_shorts: { category: "pants", shape: "pants" },
  bottoms_other: { category: "pants", shape: "pants" },
  onepiece: {
    category: "onepiece_dress",
    shape: "onepiece",
  },
