const PURCHASE_CANDIDATE_ITEM_CATEGORY_MAP = {
  ...
  bags_bag: { category: "bags", subcategory: "bag", shape: "bag" },
  ...
  bags_hand: { category: "bags", subcategory: "bag", shape: "bag" },
  bags_shoulder: { category: "bags", subcategory: "bag", shape: "shoulder" },
  bags_tote: { category: "bags", subcategory: "bag", shape: "tote" },
  bags_backpack: { category: "bags", subcategory: "bag", shape: "backpack" },
  bags_body: { category: "bags", subcategory: "bag", shape: "shoulder" },
  bags_clutch: { category: "bags", subcategory: "bag", shape: "clutch" },
  accessories_hat: {
    category: "fashion_accessories",
    subcategory: null,
    shape: "hat",
