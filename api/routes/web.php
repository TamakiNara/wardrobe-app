...
Route::prefix('api')->middleware(['web'])->group(function () {
    ...
    Route::middleware('auth:web')->controller(WeatherRecordController::class)->group(function () {
        ...
        Route::post('/weather-records/observed', 'observed');
    ...
    Route::middleware('auth:web')->controller(PurchaseCandidateController::class)->group(function () {
        ...
        Route::post('/purchase-candidates/{id}/color-variant', 'colorVariant');
    ...
    Route::middleware('auth:web')->patch('/wear-logs/{id}/feedback', [WearLogController::class, 'updateFeedback']);
