...
class CategoryMasterSeeder extends Seeder
{
    public function run(): void
    {
        $categories = [
            ...
            ['id' => 'shoes_loafers_leather', 'group_id' => 'shoes', 'name' => 'ローファー・革靴', 'sort_order' => 2],
            ...
            ['id' => 'bags_bag', 'group_id' => 'bags', 'name' => 'バッグ', 'sort_order' => 1],
            ['id' => 'bags_other', 'group_id' => 'bags', 'name' => 'その他バッグ', 'sort_order' => 2],
