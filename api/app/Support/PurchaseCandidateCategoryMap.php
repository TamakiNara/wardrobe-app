...
class PurchaseCandidateCategoryMap
{
    private const MAP = [
        ...
        'outerwear_mountain_parka' => ['category' => 'outerwear', 'shape' => 'mountain-parka'],
        ...
        'onepiece_dress_onepiece' => ['category' => 'onepiece_dress', 'shape' => 'onepiece'],
        'onepiece_dress_dress' => ['category' => 'onepiece_dress', 'shape' => 'dress'],
        'onepiece_dress_other' => ['category' => 'onepiece_dress', 'shape' => 'other'],
        'allinone_allinone' => ['category' => 'allinone', 'shape' => 'allinone'],
        'allinone_salopette' => ['category' => 'allinone', 'shape' => 'salopette'],
        'allinone_other' => ['category' => 'allinone', 'shape' => 'other'],
        ...
        'onepiece' => ['category' => 'onepiece_dress', 'shape' => 'onepiece'],
        'allinone' => ['category' => 'allinone', 'shape' => 'allinone'],
