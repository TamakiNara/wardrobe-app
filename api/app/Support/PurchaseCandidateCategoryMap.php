...
class PurchaseCandidateCategoryMap
{
    private const MAP = [
        ...
        'tops_polo_shirt' => ['category' => 'tops', 'subcategory' => 'polo_shirt', 'shape' => 'polo'],
        'tops_sweat_trainer' => ['category' => 'tops', 'subcategory' => 'sweat_trainer', 'shape' => 'sweatshirt'],
        'tops_hoodie' => ['category' => 'tops', 'subcategory' => 'hoodie', 'shape' => 'hoodie'],
        'tops_cardigan' => ['category' => 'tops', 'subcategory' => 'cardigan'],
        'tops_vest_gilet' => ['category' => 'tops', 'subcategory' => 'vest_gilet', 'shape' => 'vest'],
        'tops_camisole' => ['category' => 'tops', 'subcategory' => 'camisole'],
        'tops_tanktop' => ['category' => 'tops', 'subcategory' => 'tanktop'],
        'tops_other' => ['category' => 'tops', 'subcategory' => 'other', 'shape' => ''],
        ...
        'underwear_bra' => ['category' => 'underwear', 'subcategory' => 'bra'],
        'underwear_shorts' => ['category' => 'underwear', 'subcategory' => 'shorts'],
        'underwear_shapewear' => ['category' => 'underwear', 'subcategory' => 'shapewear'],
        'underwear_undershirt' => ['category' => 'underwear', 'subcategory' => 'undershirt'],
        'underwear_other' => ['category' => 'underwear', 'subcategory' => 'other', 'shape' => ''],
        ...
        'tops_vest' => ['category' => 'tops', 'subcategory' => 'vest_gilet', 'shape' => 'vest'],
