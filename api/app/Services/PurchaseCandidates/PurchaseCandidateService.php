        ...
        try {
            return DB::transaction(function () use ($user, $validated, &$copiedFiles) {
                ...
                $candidate = PurchaseCandidate::query()->create([
                    ...
                    'alternate_size_label' => $validated['alternate_size_label'] ?? null,
                    'alternate_size_note' => $validated['alternate_size_note'] ?? null,
                    'alternate_size_details' => $validated['alternate_size_details'] ?? null,
        ...
        if ($candidate->status === 'purchased') {
            return DB::transaction(function () use ($candidate, $validated) {
                $candidate->update([
                    ...
                    'release_date' => array_key_exists('release_date', $validated) ? $validated['release_date'] : $candidate->release_date,
                    ...
                    'discount_ends_at' => array_key_exists('discount_ends_at', $validated) ? $validated['discount_ends_at'] : $candidate->discount_ends_at,
