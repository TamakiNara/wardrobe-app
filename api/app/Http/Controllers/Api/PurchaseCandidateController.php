...
class PurchaseCandidateController extends Controller
{
    ...
    private function validateStoreRequest(Request $request): array
    {
        ...
        $validated = $request->validate([
            ...
            'spec.tops.shape' => ['nullable', 'string', 'in:tshirt,shirt,blouse,polo,sweatshirt,hoodie,knit,cardigan,vest,camisole,tanktop'],
            'spec.tops.sleeve' => ['nullable', 'string', 'in:short,five,seven,long,sleeveless,french'],
            'spec.tops.length' => ['nullable', 'string', 'in:short,normal,long'],
            'spec.tops.neck' => ['nullable', 'string', 'in:crew,v,u,square,boat,henley,highneck,camisole_neck,halter,turtle,mock,collar'],
            'spec.tops.design' => ['nullable', 'string', 'in:raglan'],
            'spec.tops.fit' => ['nullable', 'string', 'in:normal,oversized'],
